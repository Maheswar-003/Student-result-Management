...
<body>
    <form method="post" class="form-horizontal front-page">
        ...
        <?php
            $ids=$_GET['id'];
            $showquery = "SELECT * FROM userteacher WHERE id=$ids";
        ...
        //    $sql="INSERT INTO `multiusercontrol`.`userstudent`(`name`, `program`, `department`, `section`, `enrollment`, `sid`, `phone`, `email`, `password`) VALUES ('$name','$program','$department','$section','$enrollment','$sid','$phone','$email','$password')";

           $sql= "UPDATE `studentdb`.`userteacher` SET `id`='$id',`name`='$name',`department`='$department',`phone`='$phone',`email`='$email',`password`='$password' WHERE id=$id ";
        ...
        <div class="form-group">
            ...
            <div class="col-sm">
                <select class="form-control" name="department" required>
                    <option value="<?php echo $row['department'];?>" selected="selected"> - select department - </option>

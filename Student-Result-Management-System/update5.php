            ...
            <div class="container">
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    <label for=""> GPA </label>
                                    <input type="number" name="sub7" class="form-control" value="<?php echo $row['sub7'] ?>" placeholder="Enter GPA" required>
                                </div>
                    ...
                    if(isset($_POST['update']))
                    {
                        ...
                        $query = "UPDATE marksetc SET name='$name',sub7='$cgpa' WHERE id='$id'  ";
                        $query_run = mysqli_query($connection, $query);
